        ...
        <div class="mb-3">
            <select required class="form-select" name="roomtype">
                <c:choose>
                    ...
                    <c:when test="${sessionScope.room.roomType.ordinal() == 1}">
                    ...
                    <c:when test="${sessionScope.room.roomType.ordinal() == 2}">
                        <option  value="0">Friends</option>
                        <option value="1">Work</option>
                        <option selected value="2">Sport</option>
                        <option value="3">Love</option>
                        <option value="4">Education</option>
                        <option value="5">Health</option>
                        <option value="6">Politics</option>
                    </c:when>
                    <c:when test="${sessionScope.room.roomType.ordinal() == 3}">
                        <option  value="0">Friends</option>
                        <option value="1">Work</option>
                        <option value="2">Sport</option>
                        <option selected value="3">Love</option>
                        <option value="4">Education</option>
                        <option value="5">Health</option>
                        <option value="6">Politics</option>
                    </c:when>
                    <c:when test="${sessionScope.room.roomType.ordinal() == 4}">
                        <option  value="0">Friends</option>
                        <option value="1">Work</option>
                        <option value="2">Sport</option>
                        <option value="3">Love</option>
                        <option selected value="4">Education</option>
                        <option value="5">Health</option>
                        <option value="6">Politics</option>
                    </c:when>
                    <c:when test="${sessionScope.room.roomType.ordinal() == 5}">
                        <option value="0">Friends</option>
                        <option value="1">Work</option>
                        <option value="2">Sport</option>
                        <option value="3">Love</option>
                        <option value="4">Education</option>
                        <option selected value="5">Health</option>
                        <option value="6">Politics</option>
                    </c:when>
                    <c:when test="${sessionScope.room.roomType.ordinal() == 6}">
                        <option value="0">Friends</option>
                        <option value="1">Work</option>
                        <option value="2">Sport</option>
                        <option value="3">Love</option>
                        <option value="4">Education</option>
                        <option value="5">Health</option>
                        <option selected value="6">Politics</option>
                    </c:when>
                </c:choose>
